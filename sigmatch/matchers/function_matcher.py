...
class FunctionSignatureMatcher(AbstractSignatureMatcher):
    ...
    def match(self, function: Callable[..., Any], raise_exception: bool = False) -> bool:
        """We check that the signature of the function passed as an argument corresponds to the "cast" obtained during initialization of the FunctionSignatureMatcher object."""
